...
SECRET_KEY = 'django-insecure-jtg!!xv21uaw_+-c24p9cu4)nuljekm1b35=%7y(lc**!$lz-l'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'forum.context_processors.user_votes',
            ],
            'libraries': {
                'habits_filters': 'habits.templatetags.habits_filters',
            }
        },
    },
]
...
#         'console': {
#             'level': 'DEBUG',
#             'class': 'logging.StreamHandler',  # Печать в консоль
#         },
#         'file': {
#             'level': 'DEBUG',
